defmodule LetorEcom.SeedData do
  def run_seed do
    alias LetorEcom.{
      Account,
      AgentsAndSuppliers,
    ...
    {:ok, image5} =
      Catalogue.create_item_image(%{
        item_image1:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849287/grapes_hzmvdv.png",
        item_image2:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849287/grapes_hzmvdv.png",
        item_image3:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849287/grapes_hzmvdv.png",
    ...
    {:ok, image6} =
      Catalogue.create_item_image(%{
        item_image1:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849296/lemon_uelnua.png",
        item_image2:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849296/lemon_uelnua.png",
        item_image3:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849296/lemon_uelnua.png",
    ...
    {:ok, image7} =
      Catalogue.create_item_image(%{
        item_image1:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849540/milk_vpoaow.png",
        item_image2:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849540/milk_vpoaow.png",
        item_image3:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849540/milk_vpoaow.png",
    ...
    {:ok, image8} =
      Catalogue.create_item_image(%{
        item_image1:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849553/onion_zkuzio.png",
        item_image2:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849553/onion_zkuzio.png",
        item_image3:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849553/onion_zkuzio.png",
    ...
    {:ok, image9} =
      Catalogue.create_item_image(%{
        item_image1:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849564/pepper_vlmw62.png",
        item_image2:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849564/pepper_vlmw62.png",
        item_image3:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849564/pepper_vlmw62.png",
    ...
    {:ok, image11} =
      Catalogue.create_item_image(%{
        item_image1:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849595/potato_q40ppj.png",
        item_image2:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849595/potato_q40ppj.png",
        item_image3:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849595/potato_q40ppj.png",
    ...
    {:ok, image12} =
      Catalogue.create_item_image(%{
        item_image1:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849603/spinash_lxtedb.png",
        item_image2:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849603/spinash_lxtedb.png",
        item_image3:
          "https://res.cloudinary.com/letorrc/image/upload/v1596849603/spinash_lxtedb.png",
    ...
    Catalogue.update_for_special_cat(item2, %{
    ...
    Catalogue.update_for_special_cat(item3, %{
      daily_deals_id: deals.id,
      featured_item_id: featured.id
    })
    ...
    Catalogue.update_for_special_cat(item4, %{
      daily_deals_id: deals.id,
      featured_item_id: featured.id
    })
    ...
    Catalogue.update_for_special_cat(item5, %{
      daily_deals_id: deals.id,
      featured_item_id: featured.id
    })
    ...
    Catalogue.update_for_special_cat(item6, %{
      daily_deals_id: deals.id,
      featured_item_id: featured.id
    })
    ...
    Catalogue.update_for_special_cat(item8, %{
      daily_deals_id: deals.id,
      popular_item_id: featured.id
    })
